...
size_t oCWorld::readVobTree(ZenParser& parser, std::vector<zCVobData>& target, WorldVersion worldversion) {
...
void oCWorld::readObjectData(oCWorldData& info, ZenParser& parser, uint32_t versionInternal, bool forceG2) {
