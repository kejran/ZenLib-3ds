...
void Daedalus::registerGothicEngineClasses(DaedalusVM& vm) {
  ...
  if(classExists("C_SVM")) {
    REGISTER(C_SVM, MILGreetings);
    REGISTER(C_SVM, PALGreetings);
    REGISTER(C_SVM, Weather);
    REGISTER(C_SVM, IGetYouStill);
    REGISTER(C_SVM, DieEnemy);
    REGISTER(C_SVM, DieMonster);
    REGISTER(C_SVM, Addon_DieMonster);
    REGISTER(C_SVM, Addon_DieMonster2);
    REGISTER(C_SVM, DirtyThief);
    REGISTER(C_SVM, HandsOff);
    REGISTER(C_SVM, SheepKiller);
    REGISTER(C_SVM, SheepKillerMonster);
    REGISTER(C_SVM, YouMurderer);
    REGISTER(C_SVM, DieStupidBeast);
    REGISTER(C_SVM, YouDareHitMe);
    REGISTER(C_SVM, YouAskedForIt);
    REGISTER(C_SVM, ThenIBeatYouOutOfHere);
    REGISTER(C_SVM, WhatDidYouDoInThere);
    REGISTER(C_SVM, WillYouStopFighting);
    REGISTER(C_SVM, KillEnemy);
    REGISTER(C_SVM, EnemyKilled);
    REGISTER(C_SVM, MonsterKilled);
    REGISTER(C_SVM, Addon_MonsterKilled);
    REGISTER(C_SVM, Addon_MonsterKilled2);
    REGISTER(C_SVM, ThiefDown);
    REGISTER(C_SVM, RumfummlerDown);
    REGISTER(C_SVM, SheepAttackerDown);
    REGISTER(C_SVM, KillMurderer);
    REGISTER(C_SVM, StupidBeastKilled);
    REGISTER(C_SVM, NeverHitMeAgain);
    REGISTER(C_SVM, YouBetterShouldHaveListened);
    REGISTER(C_SVM, GetUpAndBeGone);
    REGISTER(C_SVM, NeverEnterRoomAgain);
    REGISTER(C_SVM, ThereIsNoFightingHere);
    REGISTER(C_SVM, SpareMe);
    REGISTER(C_SVM, RunAway);
    REGISTER(C_SVM, Alarm);
    REGISTER(C_SVM, Guards);
    REGISTER(C_SVM, Help);
    REGISTER(C_SVM, GoodMonsterKill);
    REGISTER(C_SVM, GoodKill);
    REGISTER(C_SVM, notnow);
    REGISTER(C_SVM, RunCoward);
    REGISTER(C_SVM, GetOutOfHere);
    REGISTER(C_SVM, WhyAreYouInHere);
    REGISTER(C_SVM, YesGoOutOfHere);
    REGISTER(C_SVM, WhatsThisSupposedToBe);
    REGISTER(C_SVM, YouDisturbedMySlumber);
    REGISTER(C_SVM, ITookYourGold);
    REGISTER(C_SVM, ShitNoGold);
    ...
    REGISTER(C_SVM, NextTimeYoureInForIt);
    REGISTER(C_SVM, OhMyHead);
    REGISTER(C_SVM, TheresAFight);
    REGISTER(C_SVM, OhMyGodItsAFight);
    REGISTER(C_SVM, GoodVictory);
    REGISTER(C_SVM, NotBad);
    REGISTER(C_SVM, OhMyGodHesDown);
    REGISTER(C_SVM, CheerFriend01);
    REGISTER(C_SVM, CheerFriend02);
    REGISTER(C_SVM, CheerFriend03);
    REGISTER(C_SVM, Ooh01);
    REGISTER(C_SVM, Ooh02);
    REGISTER(C_SVM, Ooh03);
    REGISTER(C_SVM, WhatWasThat);
    REGISTER(C_SVM, GetOutOfMyBed);
    REGISTER(C_SVM, Awake);
    REGISTER(C_SVM, abs_commander);
    REGISTER(C_SVM, abs_monastery);
    REGISTER(C_SVM, abs_farm);
    REGISTER(C_SVM, abs_good);
    REGISTER(C_SVM, sheepkiller_crime);
    REGISTER(C_SVM, attack_crime);
    REGISTER(C_SVM, theft_crime);
    REGISTER(C_SVM, murder_crime);
    REGISTER(C_SVM, pal_city_crime);
    REGISTER(C_SVM, mil_city_crime);
    REGISTER(C_SVM, city_crime);
    REGISTER(C_SVM, mona_crime);
    REGISTER(C_SVM, farm_crime);
    REGISTER(C_SVM, oc_crime);
    REGISTER(C_SVM, toughguy_attacklost);
    REGISTER(C_SVM, toughguy_attackwon);
    REGISTER(C_SVM, toughguy_playerattack);
    REGISTER(C_SVM, gold_1000);
    REGISTER(C_SVM, gold_950);
    REGISTER(C_SVM, gold_900);
    REGISTER(C_SVM, gold_850);
    REGISTER(C_SVM, gold_800);
    REGISTER(C_SVM, gold_750);
    REGISTER(C_SVM, gold_700);
    REGISTER(C_SVM, gold_650);
    REGISTER(C_SVM, gold_600);
    REGISTER(C_SVM, gold_550);
    REGISTER(C_SVM, gold_500);
    REGISTER(C_SVM, gold_450);
    REGISTER(C_SVM, gold_400);
    REGISTER(C_SVM, gold_350);
    REGISTER(C_SVM, gold_300);
    REGISTER(C_SVM, gold_250);
    REGISTER(C_SVM, gold_200);
    REGISTER(C_SVM, gold_150);
    REGISTER(C_SVM, gold_100);
    REGISTER(C_SVM, gold_90);
    REGISTER(C_SVM, gold_80);
    REGISTER(C_SVM, gold_70);
    REGISTER(C_SVM, gold_60);
    REGISTER(C_SVM, gold_50);
    REGISTER(C_SVM, gold_40);
    REGISTER(C_SVM, gold_30);
    REGISTER(C_SVM, gold_20);
    REGISTER(C_SVM, gold_10);
    ...
    REGISTER(C_SVM, Smalltalk25);
    REGISTER(C_SVM, Smalltalk26);
    REGISTER(C_SVM, Smalltalk27);
    REGISTER(C_SVM, Smalltalk28);
    REGISTER(C_SVM, Smalltalk29);
    REGISTER(C_SVM, Smalltalk30);
    REGISTER(C_SVM, NoLearnNoPoints);
    REGISTER(C_SVM, NoLearnOverPersonalMAX);
    REGISTER(C_SVM, NoLearnYoureBetter);
    REGISTER(C_SVM, YouLearnedSomething);
    REGISTER(C_SVM, unterstadt);
    REGISTER(C_SVM, oberstadt);
    REGISTER(C_SVM, tempel);
    REGISTER(C_SVM, markt);
    REGISTER(C_SVM, galgen);
    REGISTER(C_SVM, kaserne);
    REGISTER(C_SVM, hafen);
    REGISTER(C_SVM, whereto);
    REGISTER(C_SVM, oberstadt_2_unterstadt);
    REGISTER(C_SVM, unterstadt_2_oberstadt);
    REGISTER(C_SVM, unterstadt_2_tempel);
    REGISTER(C_SVM, unterstadt_2_hafen);
    REGISTER(C_SVM, tempel_2_unterstadt);
    REGISTER(C_SVM, tempel_2_markt);
    REGISTER(C_SVM, tempel_2_galgen);
    REGISTER(C_SVM, markt_2_tempel);
    REGISTER(C_SVM, markt_2_kaserne);
    REGISTER(C_SVM, markt_2_galgen);
    REGISTER(C_SVM, galgen_2_tempel);
    REGISTER(C_SVM, galgen_2_markt);
    REGISTER(C_SVM, galgen_2_kaserne);
    REGISTER(C_SVM, kaserne_2_markt);
    REGISTER(C_SVM, kaserne_2_galgen);
    REGISTER(C_SVM, hafen_2_unterstadt);
    REGISTER(C_SVM, Dead);
    REGISTER(C_SVM, Aargh_1);
    REGISTER(C_SVM, Aargh_2);
    REGISTER(C_SVM, Aargh_3);
    REGISTER(C_SVM, addon_wrongarmor);
    REGISTER(C_SVM, addon_wrongarmor_sld);
    REGISTER(C_SVM, addon_wrongarmor_mil);
    REGISTER(C_SVM, addon_wrongarmor_kdf);
    REGISTER(C_SVM, addon_noarmor_bdt);
    REGISTER(C_SVM, addon_diebandit);
    REGISTER(C_SVM, addon_dirtypirate);
    REGISTER(C_SVM, SC_HeyTurnAround);
    REGISTER(C_SVM, SC_HeyTurnAround02);
    REGISTER(C_SVM, SC_HeyTurnAround03);
    REGISTER(C_SVM, SC_HeyTurnAround04);
    ...
    REGISTER(C_SVM, NoPickLockTalent);
    REGISTER(C_SVM, NoSweeping);
    REGISTER(C_SVM, picklockorkeymissing);
    REGISTER(C_SVM, keymissing);
    REGISTER(C_SVM, picklockmissing);
    REGISTER(C_SVM, neveropen);
    REGISTER(C_SVM, missingitem);
    REGISTER(C_SVM, dontknow);
    REGISTER(C_SVM, nothingtoget);
    REGISTER(C_SVM, nothingtoget02);
    REGISTER(C_SVM, nothingtoget03);
    REGISTER(C_SVM, healshrine);
    REGISTER(C_SVM, heallastshrine);
    REGISTER(C_SVM, irdoraththereyouare);
    REGISTER(C_SVM, scopensirdorathbook);
    REGISTER(C_SVM, scopenslastdoor);
    REGISTER(C_SVM, trade_1);
    REGISTER(C_SVM, trade_2);
    REGISTER(C_SVM, trade_3);
    REGISTER(C_SVM, verstehe);
    REGISTER(C_SVM, foundtreasure);
    REGISTER(C_SVM, cantunderstandthis);
    REGISTER(C_SVM, cantreadthis);
    REGISTER(C_SVM, stoneplate_1);
    REGISTER(C_SVM, stoneplate_2);
    REGISTER(C_SVM, stoneplate_3);
    REGISTER(C_SVM, cough);
    REGISTER(C_SVM, hui);
    REGISTER(C_SVM, Addon_ThisLittleBastard);
    REGISTER(C_SVM, addon_openadanostemple);
    REGISTER(C_SVM, attentat_addon_description);
    REGISTER(C_SVM, attentat_addon_description2);
    REGISTER(C_SVM, attentat_addon_pro);
    REGISTER(C_SVM, attentat_addon_contra);
    REGISTER(C_SVM, mine_addon_description);
    REGISTER(C_SVM, addon_summonancientghost);
    REGISTER(C_SVM, addon_ancientghost_notnear);
    REGISTER(C_SVM, addon_gold_description);
    }
  }
